...
<div class="card card-primary">
    <div class="card-header">
        <a data-toggle="collapse" href="#collapseCNIL">
...
<div class="card card-primary">
    <div class="card-header">
        <a data-toggle="collapse" href="#collapseCNIL2">
    ...
    <div id="collapseCNIL2" class="collapse">
        <div class="card card-body">
            ...
            que vous pouvez exercer en vous adressant à <?= _ADMINISTRATEUR_NOM_ ?> via le formulaire de contact.
            <br />
