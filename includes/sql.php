...
//	{
    if (!@mysql_connect($hote, $user, $pass)) { //Ouverture de la connexion SQL //si erreur...
    ...
    if (!@mysql_select_db($base)) { //Selection de la base //si erreur...
...
function sql_query($query) {
    ...
    if (!$result_sql = mysql_query($query)) { //Ex�cution de la requ�te //si erreur...
 ...
 */
function sql_close() {
    if (!@mysql_close()) { //Fermeture de la connexion SQL //si erreur...
